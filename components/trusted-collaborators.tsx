              ...
              <article className="h-full rounded-xl border border-border bg-surface/70 p-5 transition-colors hover:border-primary/40">
                <div className="mb-3 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-primary">{collab.company}</p>
                  </div>
                ...
                {collab.linkedin ? (
                  <a
                    ...
                    className="mt-5 inline-flex items-center gap-2 font-mono text-xs text-primary transition-colors hover:text-secondary"
                  >
